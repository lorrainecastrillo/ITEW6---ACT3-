  ...
  data() {
    return {
      products: [
        ...
        { id: 4, name: 'ECG Necklace', description: 'Silver Necklace', price: 4000 },
        { id: 5, name: 'ECG Necklace', description: 'Gold Necklace', price: 5500 },
        { id: 5, name: 'ECG Necklace', description: 'Garnet Necklace', price: 6500 }
      ]
    };
  },
  methods: {
